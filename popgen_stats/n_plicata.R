...
library(raster)
getwd()
setwd("C:/Users/jacog/Desktop/Dongsha/data/n_plicata")
list.files("C:/Users/jacog/Desktop/Dongsha/data/n_plicata")
cstr<-read.FASTA("n_plicata.fasta")
...
cstr_m<-read.csv("cstr_metadata.csv")
